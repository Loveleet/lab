...
const commonColumnOptions = [
  ...
  { label: 'Created At', value: 'created_at' },
  { label: 'Unique ID', value: 'Unique_id' },
  // Trade/exchange status fields from alltraderecords/m1
  { label: 'Is Execute In Exchange', value: 'is_execute_in_exchange' },
  { label: 'Exchange Position', value: 'exchange_position' },
  { label: 'Auto', value: 'auto' },
  { label: 'Update Table', value: 'update_table' },
  { label: 'Is Enabled', value: 'is_enabled' },
  // PL / hedge metrics (mapped from trade data)
  { label: 'PL', value: 'PL' },
...
const tradeDataColumnOptions = [
  { label: 'is_execute_in_exchange', value: 'is_execute_in_exchange' },
  ...
  { label: 'is_execute_in_exchange', value: 'is_execute_in_exchange' },
  { label: 'exchange_position', value: 'exchange_position' },
  { label: 'auto', value: 'auto' },
  { label: 'update_table', value: 'update_table' },
  { label: 'is_enabled', value: 'is_enabled' }
];
